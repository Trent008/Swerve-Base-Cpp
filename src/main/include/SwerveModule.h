...
#include "Falcon500.h"
#include "utilities/angleOptimization.h"
...
private:
    ...
    float currentWheelAngle; // current wheel angle
    float error; // wheel angle error
    Vector moduleTargetVelocity; // robot-centric module target velocity
    float driveMotorVelocity; // drive motor velocity setpoint
